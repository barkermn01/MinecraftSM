	...
	public void inst_port(String name) throws IOException {
		...
		if(confirm()){
			...
			try{
				...
				System.out.println("port is used by another instance or MinecraftSM web servers");
			}
		}		
	}
